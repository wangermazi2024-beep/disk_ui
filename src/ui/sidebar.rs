...
pub fn show(ui: &mut egui::Ui, used_size: u64, total_size: u64, free_size: u64, categories: &[CategoryStat]) {
    egui::Panel::left("stats_panel")
        ...
        .frame(
            egui::Frame::default()
                .fill(Color32::from_rgb(0x2B, 0x2B, 0x2E))
        ...
        .show(ui, |ui| {
            ...
            painter.rect_filled(rect, CornerRadius::same(10), Color32::from_rgb(0x38, 0x3A, 0x3E));
            ...
            for c in categories {
                ...
                bp.rect_filled(bar_rect, CornerRadius::same(2), Color32::from_rgb(0x38, 0x3A, 0x3E));
